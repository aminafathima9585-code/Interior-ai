...
import { generateImage, buildCustomizationPrompt, hasHuggingFaceToken } from '@/lib/huggingface';

// Mock images for fallback
const mockCustomizationImages = [
  'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800&h=600&fit=crop',
  'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&h=600&fit=crop',
  'https://images.unsplash.com/photo-1600566753190-17f0baa2a2a6c3?w=800&h=600&fit=crop',
];
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Use Hugging Face for real image customization (primary method)
    if (hasHuggingFaceToken) {
      try {
        ...
        console.error('Pollinations customization error:', pollError);
      }
    }
    ...
    // Final fallback: CSS-based customization
